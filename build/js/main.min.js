...
/* harmony import */ var _modules_show_more_information__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/show-more-information */ "./js/modules/show-more-information.js");
/* harmony import */ var _modules_show_more_information__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_show_more_information__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _utils_modal_interaction__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/modal-interaction */ "./js/utils/modal-interaction.js");
/* harmony import */ var _utils_phone_mask__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/phone-mask */ "./js/utils/phone-mask.js");
/* harmony import */ var _utils_phone_mask__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_utils_phone_mask__WEBPACK_IMPORTED_MODULE_6__);
...
if (window.matchMedia('(max-width: 769px)').matches) {
  var accordionWrappers = document.querySelectorAll('.footer__section-wrapper');
  accordionWrappers.forEach(function (wrapper) {
    wrapper.addEventListener('click', function (e) {
      ...
      accordionWrappers.forEach(function (accordion) {
...
/***/ "./js/modules/show-more-information.js":
/*!*********************************************!*\
  !*** ./js/modules/show-more-information.js ***!
  \*********************************************/
/*! no static exports found */
...
var moreInfoButton = document.querySelector('.company-information__more-information-button');
var companyDescription = document.querySelector('.company-information__description-wrapper');
...
var openModal = function openModal(modalContainer, modal, openModalButton) {
  var autofocus = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
...
var closeModal = function closeModal(modalContainer, modal, closeModalButton) {
...
var openModalButton = document.querySelector('.header__order-call-button');
var closeModalButton = document.querySelector('.modal__close-button');
var autofocusField = document.consultationForm.userName;
if (openModalButton) {
...
document.addEventListener('DOMContentLoaded', function () {
  var getUserNumberMask = function getUserNumberMask(evt) {
    var phoneInput = evt.target;
    var clearInputValue = phoneInput.dataset.phoneClear;
    var pattern = phoneInput.dataset.phonePattern;
    var maskDefault = '+7(__________)';
    var mask = pattern ? pattern : maskDefault;
    var i = 0;
    var defaultValue = mask.replace(/\D/g, '');
